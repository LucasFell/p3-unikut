...
public class Aplicacao {
    ...
    * @author Lucas
     */
    public static void menuAddAmigos() {
        System.out.println("\nAdicionar Amigos");
    ...
    public static void menuMain() {
        ...
        System.out.println("5 => Ver Solicitacoes de Amizade");
        System.out.println("6 => Ver Recados");
                    ...
                    while (opcao2 != 10) {
                        switch (opcao2) {
                                ...
                                while (opcao3 != 3) {
                                    switch (opcao3) {
                                        case 1 -> { // Alterar Apelido
                                            ...
                                            social.alterarContaNome(login, newNickName);
                                            social.exibir();
                                        ...
                                        case 2 -> { // Alterar Senha
                                            ...
                                            social.alterarContaSenha(login, newPassword);
                                            social.exibir();
                            ...
                            case 3 -> { // Adicionar amigos
                                menuAddAmigos();
                                int opcao4 = s.nextInt();
                                while (opcao4 != 2) {
                                    switch (opcao4) {
                                        case 1 -> {
                                            System.out.print("\nDigite o Login do seu Amigo: ");
                                            String loginAmigo = s.nextLine();
                                            while (!social.verificaLogin(loginAmigo)) {
                            ...
                            case 5 -> { // Ver Solicitaçoes de Amizade
